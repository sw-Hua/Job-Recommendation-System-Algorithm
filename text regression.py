...
# 加载数据
file_path = "C:/Users/28905/Documents/NTU/semester2/CI/algorithm/dataset.csv"
...
# Plotting confusion matrices for job and skill predictions
plot_confusion_matrix(y_test_jobs, y_pred_jobs, 'BestFitJob')
plot_confusion_matrix(y_test_skills, y_pred_skills, 'SkillsNeeded')
